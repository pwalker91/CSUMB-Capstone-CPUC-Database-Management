...
FILELOCATION = "/Users/peterwalker/Documents/GitHub/CSUMB_Capstone-CPUC-Database-Management/ParsingAndStoring/FieldTest_SampleTests/"
...
for file in parsedFiles:
    ...
    newID = api.insert("Overview",
                OSName_OSArchitecture_OSVersion = ("{} | {} | {}".format(file.OSName, file.OSArchitecture, file.OSVersion)),
                ...
                AvgLongitude = (statistics.mean(avgLng) if len(avgLat)>0 else 0),
