...
FUNCTIONS:
    __init__ - Used to initialize an object of this class
        ...
        OUTPUTS-    none
    arrayOfMsmts - Will return an array of the Measurements in self.Measurements as an array
        ...
        OUTPUTS-    list, containing all of the values in the Measurement object of myMeasurements
...
from PyObjects._Measurement import Measurement as Msmt
from PyObjects._Measurement import Final_Measurement as FMsmt
#END IMPORTS
...
class Thread(Formatting):
    ...
    # DESC: Will return an array of the Measurements in self.myMeasurements as an array
    #       of Numbers. Can be given the attribute of the measurement that needs to be arraytized
