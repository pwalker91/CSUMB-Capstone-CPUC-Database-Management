...
VARIABLES:
    StringPadding       String, the number of spaces that each object will
                        use a multiple of
    ConfirmedCarriers   List, accepted/confirmed carriers used in the tests.
...
VARIABLES:
    ContainsErrors  Boolean, whether the object contains errors
    ErrorCode       Integer, the code number for the error.
    ErrorTypes      Dictionary, number codes that correspond to a specific error
                    type. Will also be used to find the messageString, the number of spaces that each object will
                    use a multiple of
    ErrorMessages   List, accepted/confirmed carriers used in the tests.
                    Used for organization.
