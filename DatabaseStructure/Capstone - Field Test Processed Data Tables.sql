...
-- Generated at Sat Mar 07 18:08:00 UTC 2015
...
CREATE TABLE `FileOverview` (
 ...
 COMMENT 'This table holds the basic information of a single test file. This included the device type, the device ID, the location ID, etc.'
;
